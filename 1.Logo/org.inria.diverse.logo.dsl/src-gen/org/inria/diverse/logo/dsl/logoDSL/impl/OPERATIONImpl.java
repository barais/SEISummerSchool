 ...
 * </p>
 * <ul>
 *   <li>{@link org.inria.diverse.logo.dsl.logoDSL.impl.OPERATIONImpl#getTargetVariable <em>Target Variable</em>}</li>
 *   <li>{@link org.inria.diverse.logo.dsl.logoDSL.impl.OPERATIONImpl#getValOne <em>Val One</em>}</li>
 *   <li>{@link org.inria.diverse.logo.dsl.logoDSL.impl.OPERATIONImpl#getValTwo <em>Val Two</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OPERATIONImpl extends SENTENCEImpl implements OPERATION
{
  ...
  {
    return LogoDSLPackage.Literals.OPERATION;
  }
    ...
    if (targetVariable != null && targetVariable.eIsProxy())
    {
      ...
      if (targetVariable != oldTargetVariable)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, LogoDSLPackage.OPERATION__TARGET_VARIABLE, oldTargetVariable, targetVariable));
      }
    }
  ...
  public void setTargetVariable(MAKE newTargetVariable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LogoDSLPackage.OPERATION__TARGET_VARIABLE, oldTargetVariable, targetVariable));
  }
  ...
  public NotificationChain basicSetValOne(EXPRESSION newValOne, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LogoDSLPackage.OPERATION__VAL_ONE, oldValOne, newValOne);
  ...
  public void setValOne(EXPRESSION newValOne)
  {
    if (newValOne != valOne)
    {
      ...
      if (valOne != null)
        msgs = ((InternalEObject)valOne).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LogoDSLPackage.OPERATION__VAL_ONE, null, msgs);
      if (newValOne != null)
        msgs = ((InternalEObject)newValOne).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LogoDSLPackage.OPERATION__VAL_ONE, null, msgs);
      msgs = basicSetValOne(newValOne, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LogoDSLPackage.OPERATION__VAL_ONE, newValOne, newValOne));
  }
  ...
  public NotificationChain basicSetValTwo(EXPRESSION newValTwo, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LogoDSLPackage.OPERATION__VAL_TWO, oldValTwo, newValTwo);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setValTwo(EXPRESSION newValTwo)
  {
    if (newValTwo != valTwo)
    {
      NotificationChain msgs = null;
      if (valTwo != null)
        msgs = ((InternalEObject)valTwo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LogoDSLPackage.OPERATION__VAL_TWO, null, msgs);
      if (newValTwo != null)
        msgs = ((InternalEObject)newValTwo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LogoDSLPackage.OPERATION__VAL_TWO, null, msgs);
      msgs = basicSetValTwo(newValTwo, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LogoDSLPackage.OPERATION__VAL_TWO, newValTwo, newValTwo));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case LogoDSLPackage.OPERATION__VAL_ONE:
        return basicSetValOne(null, msgs);
      case LogoDSLPackage.OPERATION__VAL_TWO:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LogoDSLPackage.OPERATION__TARGET_VARIABLE:
